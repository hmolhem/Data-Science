...
calculate_averages('source.csv', 'task01.csv') #task01
calculate_sorted_averages('source.csv', 'task02.csv') #task02
calculate_three_best('source.csv', 'task03.csv') #task03
calculate_three_worst('source.csv', 'task04.csv') #task04
calculate_average_of_averages('source.csv', 'task05.csv') # task05
